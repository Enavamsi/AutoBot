 ...
 *
 * TRANSPORT: WiFi / UDP (no USB cable needed once flashed).
 * Set WIFI_SSID, WIFI_PASSWORD, and AGENT_IP below to match your network
 * and the machine running the micro-ROS agent.
 *
...
// ==========================================================
// WIFI / MICRO-ROS AGENT CONFIG - EDIT THESE FOR YOUR NETWORK
// ==========================================================
#define WIFI_SSID       "CONNECT AND DIE"
#define WIFI_PASSWORD   "nfdq5490"
#define AGENT_IP        "10.116.94.9"   // IP of the PC running micro_ros_agent
...
// ==========================================================
void setup() {
  // --- Debug output (transport is WiFi now, so Serial is free to use) ---
  Serial.begin(115200);
  ...
  // --- micro-ROS transport (WiFi/UDP to the agent) ---
